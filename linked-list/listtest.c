...
int main(int argc, char **argv)
{
     ...
     * LIST_HEAD(mylist); which declares and initialized the list
     */
    ...
    /* now you have circularly linked list of items of type struct kool_list.
	...
	/* given a pointer to struct list_head, type of data structure it is part
	 * and it's name (struct list_head's name in the data structure) it return
    ...
    list_for_each_entry(tmp, &mylist, list)
	printf("to= %d from %d\n", tmp->to, tmp->from);
    printf("\n");
