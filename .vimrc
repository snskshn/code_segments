...
"Print current function prototype
fun! ShowFuncName()
  let lnum = line(".")
  let col = col(".")
  echohl ModeMsg
...
map <f5> :cN<cr>
map <f6> :cn<cr>
map <f9> :!ctags -R; find . -name '*.[ch]' > cscope.files; cscope -b<cr> :cs reset<cr>
map <f10> :tp<cr>
map <f11> :tn<cr>
map <f12> :tabn<cr>
...
if has("autocmd")
 augroup cprog
  ...
  autocmd FileType c,cpp,cc,C  set formatoptions=croql cindent shiftwidth=4 comments=sr:/*,mb:*,el:*/,://
