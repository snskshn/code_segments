...
"  echomsg "dirname<".a:dirname.">"
  if has("amiga")
   ...
   if a:dirname != '' && isdirectory(fnameescape(a:dirname))
    silent! call netrw#LocalBrowseCheck(fnameescape(a:dirname))
   endif
  elseif isdirectory(fnameescape(a:dirname))
"   echomsg "dirname<".fnameescape(dirname)."> isdir"
